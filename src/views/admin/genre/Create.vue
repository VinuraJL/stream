                  ...
                  <div class="mt-3 sm:mt-5">
                    ...
                    <div class="mt-2">
                      <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
                        ...
                        <!-- Image -->
                        <div class="sm:col-span-8">
                          <label for="image" class="block text-sm font-medium leading-6 text-white">Image</label>
                          <div class="mt-2">
                            <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-white focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                              <input
                                type="file"
                        ...
                        <div class="sm:col-span-4">
                          <label for="sort_order" class="block text-sm font-medium leading-6 text-white">Sort Order</label>
                          <div class="mt-2">
                            <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-white focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                              <input
                                type="number"
