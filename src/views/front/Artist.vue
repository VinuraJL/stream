  ...
  <div>
    ...
    <div class="px-4 sm:px-6 lg:px-8">
      ...
      <div class="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        ...
        >
          <img :src="artist.avatar" alt="Artist Avatar" class="h-32 w-32 rounded-full object-cover">
          <h3 class="mt-4 text-lg font-medium text-gray-900">{{ artist.name }}</h3>
...
const navigation = [
  ...
  { name: 'Artists', href: '/front/artist', current: true },
